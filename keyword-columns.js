...
function inferIcpAxis(name){
 ...
 if(n==='company size'||n==='input'||n==='inputs'||n==='headcount')return 'input';
 return 'process';
}
...
const icpAxisPrompt="ICP AXES\nIn every ICP Listicle, Informational and Landing table, organize columns under four axes. People covers Role / Team. Technology covers Technology or the existing tech stack. Process covers Industry, Country and Use Case. Input covers Company Size or workload scale. Do not create or route content to Maturity Stage. Treat the axis as a structural group, then use the specific column to classify the content.";
