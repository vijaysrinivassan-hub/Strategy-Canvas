...
assert(html.includes('source.textContent = model.exampleLabel'));
...
assert(html.includes("marketLabel:'Data material providers market'"));
assert(html.includes("sourceMarket.textContent = model.marketLabel"));
...
assert(html.includes('market.textContent = model.marketLabel'));
