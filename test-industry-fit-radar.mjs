...
assert(html.includes("axisRow(modelControlsPuzzle ? selectedModel.axis : buying.axis, 'target')"));
...
assert(html.includes("details.className = 'industry-model-details'"));
assert(html.includes('details.append(name, pages)'));
