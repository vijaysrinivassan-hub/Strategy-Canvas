...
assert(html.includes("previewLeft.append(sellingHeading, previewName, axisRow('technology'))"));
...
assert(html.includes("previewRight.append(buyingHeading, previewAxis, axisRow(selectedModel ? selectedModel.axis : ''))"));
