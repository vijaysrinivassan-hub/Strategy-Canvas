...
assert(html.includes("const MATURITY_ACCESS_TAB = 'Strategy 1 — Maturity Access'"));
assert(html.includes("box.append(tabButton(MATURITY_ACCESS_TAB, 'Maturity Access'))"));
...
assert(html.includes("architecture.name = 'Maturity Access'"));
